...
#CSV_FILE = "nifty50_fractal_levels_30min.csv"
#CSV_FILE = "nifty50_fractal_levels_1day.csv"
#CSV_FILE = "nifty50_fractal_levels_1week.csv"
...
def monitor_stocks():
    ...
    """ \n Low = """ +  str(len(upside_bo_msg_list)) + """\n High = """+ str(len(downside_bo_msg_list)) + """ \n """  \
...
if __name__ == "__main__":
    user_input = int(input("Enter 1 for 30minute Timeframe, 2 for 1Day Timeframe, 3 for 1week Timeframe: "))
    if user_input == 1:
        CSV_FILE = "nifty50_fractal_levels_30min.csv"
        tt = "\n\n #30min"
    elif user_input == 2:
